...
export const DataplicityIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c1.356 0 2.673-.11 3.955-.322M12 21c-1.356 0-2.673-.11-3.955-.322m7.91 0a9.006 9.006 0 00-7.91 0M12 3a9.004 9.004 0 018.716 6.747M12 3a9.004 9.004 0 00-8.716 6.747M12 3c1.356 0 2.673.11 3.955.322M12 3c-1.356 0-2.673-.11-3.955-.322" />
        <circle cx="12" cy="12" r="2.25" stroke="currentColor" strokeWidth="1.5" />
        <circle cx="18.364" cy="18.364" r="1.125" stroke="currentColor" strokeWidth="1.5" />
        <circle cx="5.636" cy="5.636" r="1.125" stroke="currentColor" strokeWidth="1.5" />
        <circle cx="18.364" cy="5.636" r="1.125" stroke="currentColor" strokeWidth="1.5" />
        <circle cx="5.636" cy="18.364" r="1.125" stroke="currentColor" strokeWidth="1.5" />
    </svg>
);
