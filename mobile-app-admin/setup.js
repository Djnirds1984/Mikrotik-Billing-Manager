/**
 * ISP Billing Admin — mobile shell setup logic.
 *
 ...
 * remote admin panel login (served at the domain root). Every screen after
 * the redirect is served by the panel.
 *
...
// Admin panel login lives at the domain root (unlike the customer app's /client_portal)
const PORTAL_PATH = '/';
...
async function handleConnect() {
  ...
  showStatus('ok', 'Connected. Opening the admin panel…');
  await redirectToPanel(domain);
}
