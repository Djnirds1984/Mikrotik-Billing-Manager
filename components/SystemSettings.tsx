...
import { KeyIcon, CogIcon, PowerIcon, RouterIcon, CircleStackIcon, ArrowPathIcon, TrashIcon, UsersIcon, DataplicityIcon } from '../constants.tsx';
...
export const SystemSettings: React.FC<SystemSettingsProps> = ({ selectedRouter, licenseStatus }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <SettingsCard title="Ngrok Remote Access" icon={<DataplicityIcon className="w-6 h-6" />}>
                <NgrokManager />
            </SettingsCard>
